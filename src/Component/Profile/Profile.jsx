...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        const getOrderData = async () => {
            try {
                let res = await axios.get("https://api.myriccoproducts.com/api/checkout/" + sessionStorage.getItem("userid"));
    ...
    return (
        <>
            <div className="container-fluid profileheight">
                <div className="row">
                                    ...
                                    <table className='table table-bordered'>
                                        ...
                                        <tbody>
                                            {item.products.map((product, idx) => (
                                                <tr key={idx}>
                                                    <td><a href={product.pic} target='_blank'><img src={product.pic} alt="" style={{ height: 70, width: 70 }} /></a></td>
